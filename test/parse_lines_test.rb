...
class TestParser < Test::Unit::TestCase
  ...
  def setup
    ...
    # Example 1
    ex_1 = Hash.new
    ex_1["input"] = ["/n", "This is", "# A test", "## To see", "### if this", "* function", "/n", "/n", "> works"]
    ex_1["type_expected"] = ["p", "p", "h1", "h2", "h3", "li", "p", "p", "bq"]
    ex_1["string_expected"] = ["/n", "This is", "A test", "To see", "if this", "function", "/n", "/n", "works"]
    ...
    # Example 3
    ex_3 = Hash.new
    ex_3["input"] = ["/n", "normal", "* list", "## a header"]
    ex_3["type_expected"] = ["p", "p", "li", "h2"]
    ex_3["string_expected"] = ["/n", "normal", "list", "a header"]
